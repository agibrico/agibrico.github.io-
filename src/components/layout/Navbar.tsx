        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {user ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-bold text-slate-700 hover:bg-slate-100 border border-slate-200 transition-all cursor-pointer"
            >
